...
pnpm db:seed          # siembra catálogo + usuario admin
pnpm dev              # arranca store (3000) y admin (3001)
```

- **Store**: http://localhost:3000
- **Admin**: http://localhost:3001 — login: `admin@bubba.mx` / `admin123`

## Scripts raíz

| Comando            | Descripción                                |
| ------------------ | ------------------------------------------ |
| `pnpm dev`         | Arranca ambas apps en desarrollo           |
...
| `pnpm db:seed`     | Siembra catálogo y usuario admin           |
...
**Admin**
- Login por credenciales (Auth.js) y rutas protegidas.
- Dashboard con métricas de pedidos del día.
- CRUD de tamaños, sabores y tipos de boba.
- Gestión de pedidos: filtro por estado y avance en la secuencia recibido → en preparación → entregado.
