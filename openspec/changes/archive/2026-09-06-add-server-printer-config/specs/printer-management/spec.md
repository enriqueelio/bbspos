...
El sistema SHALL enviar a la impresora de comandas configurada el ticket del pedido (número, cliente, fecha, bebidas con toppings, total) inmediatamente después de confirmarse el pedido en la tienda.
...
- **THEN** el servidor imprime la comanda con los datos del pedido sin intervención del cliente
...
- **WHEN** el cajero pulsa "Reimprimir" sobre un pedido en su cola
- **THEN** el servidor envía nuevamente la comanda del pedido a la impresora configurada e informa el resultado
