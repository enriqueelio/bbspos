...
El catálogo SHALL ser legible por la tienda sin autenticación y editable únicamente por usuarios autenticados del admin, incluyendo tamaños, sabores, tipos de boba, matriz de precios y toppings. Dentro de la gestión del menú del admin, todos los componentes del catálogo de bebidas (tamaños de vaso, sabores, tipos de boba, toppings y matrices de precios) SHALL agruparse en una sección única llamada **Bubas**.
...
#### Scenario: El admin edita el catálogo de bebidas

- **WHEN** el admin abre la gestión del menú
- **THEN** los componentes del catálogo de bebidas aparecen agrupados dentro de la sección Bubas
